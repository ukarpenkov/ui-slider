...
(function handleRange() {
    ...
    function rangeInputChangeEventHandler(e) {
        ...
        var minBtn = $(this).children().children('.js-uk-min');
        var maxBtn = $(this).children().children('.js-uk-max');
        var range_min = $(this).children().children('.js-uk-range_min');
        var range_max = $(this).children().children('.js-uk-range_max');
        var minVal = Number($(minBtn).val());
        var maxVal = Number($(maxBtn).val());
    ...
    $('.uk-slider').ready(rangeInputChangeEventHandler());
    $('.uk-slider').on('change', rangeInputChangeEventHandler);
