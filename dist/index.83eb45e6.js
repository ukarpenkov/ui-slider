 ...
 */ (function(global, factory) {
    "use strict";
    if (typeof $6b0b4f3e43796c62$exports === "object") // For CommonJS and CommonJS-like environments where a proper `window`
    ...
    $6b0b4f3e43796c62$exports = global.document ? factory(global, true) : function(w) {
        if (!w.document) throw new Error("jQuery requires a window with a document");
        return factory(w);
    };
    else factory(global);
// Pass this if window is not defined yet
})(typeof window !== "undefined" ? window : $6b0b4f3e43796c62$exports, function(window1, noGlobal) {
...
var $a4e1ab761d186478$export$2e2bcd8739ae039 = window.$ = window.jQuery = (0, (/*@__PURE__*/$parcel$interopDefault($6b0b4f3e43796c62$exports)));


function $f3a8aed1cb2e3c7f$export$1650419e431d3ba3(state, action) {
    switch(action.type){
        case "ADD_SLIDER":
            return [
                ...state,
...
function $345304aa5a5ccf57$var$createStore(reducer, initialState) {
...
const $345304aa5a5ccf57$var$initialSlider = [];
const $345304aa5a5ccf57$export$6f57813fe9f31bf9 = $345304aa5a5ccf57$var$createStore((0, $f3a8aed1cb2e3c7f$export$1650419e431d3ba3), $345304aa5a5ccf57$var$initialSlider);




function $f60ae9f3d286693b$export$897858b8ab7d7af7() {
    ...
    (0, $345304aa5a5ccf57$export$6f57813fe9f31bf9).dispatch({
        type: "CHANGE_MIN_SCALE",
        id: toolbarId,
        payload: minScaleValue
    });
    (0, $d8c19bd671c99e09$export$da0a1bf29795ef91)();
    (0, $d8c19bd671c99e09$export$8ff95cf51e6fac2b)();
}
function $f60ae9f3d286693b$export$88f9b7a69ad0b0c1() {
...
function $f60ae9f3d286693b$export$499c50b9584e2d6d() {
...
function $f60ae9f3d286693b$export$eda6c2a03a956ab4() {
...
function $f60ae9f3d286693b$export$baa808bb291a2865() {
...
function $f60ae9f3d286693b$export$2b1e75baf3a08712() {
    let verticalOrHorizontalCheckbox = $(this);
    let toolbarContainer = $(verticalOrHorizontalCheckbox).parent().parent().parent()[0];
    let toolbarId = $(toolbarContainer)?.attr("class")?.split(" ")[1];
    if ($(verticalOrHorizontalCheckbox).is(":checked")) (0, $345304aa5a5ccf57$export$6f57813fe9f31bf9).dispatch({
        type: "VERTICAL_ORIENTANTION",
        id: toolbarId
    });
    else (0, $345304aa5a5ccf57$export$6f57813fe9f31bf9).dispatch({
        type: "HORIZONTAL_ORIENTANTION",
        id: toolbarId
    });
    (0, $d8c19bd671c99e09$export$da0a1bf29795ef91)();
}
function $f60ae9f3d286693b$export$af11dab7dd692ae9() {
    let singleOrRangeCheckbox = $(this);
    let toolbarContainer = $(singleOrRangeCheckbox).parent().parent().parent()[0];
    let toolbarId = $(toolbarContainer)?.attr("class")?.split(" ")[1];
    if ($(singleOrRangeCheckbox).is(":checked")) (0, $345304aa5a5ccf57$export$6f57813fe9f31bf9).dispatch({
        type: "SET_SINGLE",
        id: toolbarId
    });
    else (0, $345304aa5a5ccf57$export$6f57813fe9f31bf9).dispatch({
...
function $f60ae9f3d286693b$export$cf8110c6412d0a13() {
...
function $f60ae9f3d286693b$export$d1bf39eaaabfba47() {
...
function $f8a543986422c4a9$var$initToolBar(wrapper) {
    let state = (0, $345304aa5a5ccf57$export$6f57813fe9f31bf9).getState();
...
var $f8a543986422c4a9$export$2e2bcd8739ae039 = $f8a543986422c4a9$var$initToolBar;



const $76988ab6c211f4a5$export$2b57d60599a63da5 = ()=>{
...
const $76988ab6c211f4a5$export$92d4e20e0acb0b06 = ()=>{
...
const $d8c19bd671c99e09$export$da0a1bf29795ef91 = ()=>{
    $(".sliders-container").remove();
    (0, $626fac56391ba660$export$2e2bcd8739ae039)(".slider-page");
    (0, $76988ab6c211f4a5$export$92d4e20e0acb0b06)();
};
const $d8c19bd671c99e09$export$8ff95cf51e6fac2b = ()=>{
    $(".control-panel").remove();
    (0, $f8a543986422c4a9$export$2e2bcd8739ae039)(".toolbar-page");
    $("input[name='minScale']").on("change", (0, $f60ae9f3d286693b$export$897858b8ab7d7af7));
    $("input[name='maxScale']").on("change", (0, $f60ae9f3d286693b$export$88f9b7a69ad0b0c1));
    $("input[name='minPosition']").on("change", (0, $f60ae9f3d286693b$export$499c50b9584e2d6d));
    $("input[name='maxPosition']").on("change", (0, $f60ae9f3d286693b$export$eda6c2a03a956ab4));
    $("input[name='scaleStep']").on("change", (0, $f60ae9f3d286693b$export$baa808bb291a2865));
    $("input[name='verticalOrHorizontal']").on("change", (0, $f60ae9f3d286693b$export$2b1e75baf3a08712));
    $("input[name='singleOrRange']").on("change", (0, $f60ae9f3d286693b$export$af11dab7dd692ae9));
    $("input[name='progressBar']").on("change", (0, $f60ae9f3d286693b$export$cf8110c6412d0a13));
    $("input[name='scaleRange']").on("change", (0, $f60ae9f3d286693b$export$d1bf39eaaabfba47));
    (0, $76988ab6c211f4a5$export$92d4e20e0acb0b06)();
};


function $626fac56391ba660$var$initSlider(wrapper) {
    let state = (0, $345304aa5a5ccf57$export$6f57813fe9f31bf9).getState();
...
var $626fac56391ba660$export$2e2bcd8739ae039 = $626fac56391ba660$var$initSlider;




class $4d19055420411a98$export$f1e8abe023402588 {
...
let $38d990df5795bd1b$var$slider1 = new (0, $4d19055420411a98$export$f1e8abe023402588)("1", "interval", "horizontal", 1, 50, 1, 100, 1, true, true);
$38d990df5795bd1b$var$slider1.init();
let $38d990df5795bd1b$var$slider2 = new (0, $4d19055420411a98$export$f1e8abe023402588)("2", "interval", "vertical", 1, 20, 1, 20, 1, true, true);
$38d990df5795bd1b$var$slider2.init();
let $38d990df5795bd1b$var$slider3 = new (0, $4d19055420411a98$export$f1e8abe023402588)("3", "single", "horizontal", 1, 20, 1, 20, 1, true, true);
$38d990df5795bd1b$var$slider3.init();
(0, $626fac56391ba660$export$2e2bcd8739ae039)(".slider-page");
(0, $76988ab6c211f4a5$export$2b57d60599a63da5)();
(0, $76988ab6c211f4a5$export$92d4e20e0acb0b06)();

})();
//# sourceMappingURL=index.83eb45e6.js.map
