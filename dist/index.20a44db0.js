...
var $5307647ac6d1e96f$export$2e2bcd8739ae039 = window.$ = window.jQuery = (0, (/*@__PURE__*/$parcel$interopDefault($a7dd4053b0e59561$exports)));


function $16ac0a243a053ce1$export$1650419e431d3ba3(state, action) {
  switch (action.type) {
    case "ADD_SLIDER":
      return [
        ...state,
...
function $7080dfdb5bc149f5$var$createStore(reducer, initialState) {
...
const $7080dfdb5bc149f5$var$initialSlider = [];
const $7080dfdb5bc149f5$export$6f57813fe9f31bf9 = $7080dfdb5bc149f5$var$createStore((0, $16ac0a243a053ce1$export$1650419e431d3ba3), $7080dfdb5bc149f5$var$initialSlider);




function $e85695d92ef43ad2$export$897858b8ab7d7af7() {
  ...
  (0, $7080dfdb5bc149f5$export$6f57813fe9f31bf9).dispatch({
    type: "CHANGE_MIN_SCALE",
    id: toolbarId,
    payload: minScaleValue
  });
  (0, $a7e9b6c4274797b7$export$da0a1bf29795ef91)();
  (0, $a7e9b6c4274797b7$export$8ff95cf51e6fac2b)();
}
function $e85695d92ef43ad2$export$88f9b7a69ad0b0c1() {
...
function $e85695d92ef43ad2$export$499c50b9584e2d6d() {
...
function $e85695d92ef43ad2$export$eda6c2a03a956ab4() {
...
function $e85695d92ef43ad2$export$baa808bb291a2865() {
...
function $e85695d92ef43ad2$export$2b1e75baf3a08712() {
  let verticalOrHorizontalCheckbox = $(this);
  let toolbarContainer = $(verticalOrHorizontalCheckbox).parent().parent().parent()[0];
  let toolbarId = $(toolbarContainer)?.attr("class")?.split(" ")[1];
  if ($(verticalOrHorizontalCheckbox).is(":checked")) (0, $7080dfdb5bc149f5$export$6f57813fe9f31bf9).dispatch({
    type: "VERTICAL_ORIENTANTION",
    id: toolbarId
  });
  else (0, $7080dfdb5bc149f5$export$6f57813fe9f31bf9).dispatch({
    type: "HORIZONTAL_ORIENTANTION",
    id: toolbarId
  });
  (0, $a7e9b6c4274797b7$export$da0a1bf29795ef91)();
}
function $e85695d92ef43ad2$export$af11dab7dd692ae9() {
  let singleOrRangeCheckbox = $(this);
  let toolbarContainer = $(singleOrRangeCheckbox).parent().parent().parent()[0];
  let toolbarId = $(toolbarContainer)?.attr("class")?.split(" ")[1];
  if ($(singleOrRangeCheckbox).is(":checked")) (0, $7080dfdb5bc149f5$export$6f57813fe9f31bf9).dispatch({
    type: "SET_SINGLE",
    id: toolbarId
  });
  else (0, $7080dfdb5bc149f5$export$6f57813fe9f31bf9).dispatch({
...
function $e85695d92ef43ad2$export$cf8110c6412d0a13() {
...
function $e85695d92ef43ad2$export$d1bf39eaaabfba47() {
...
function $ac4bc82834447809$var$initToolBar(wrapper) {
  let state = (0, $7080dfdb5bc149f5$export$6f57813fe9f31bf9).getState();
...
var $ac4bc82834447809$export$2e2bcd8739ae039 = $ac4bc82834447809$var$initToolBar;



export const $b29e4f8572f5178c$export$2b57d60599a63da5 = () => {
...
export const $b29e4f8572f5178c$export$92d4e20e0acb0b06 = () => {
...
const $a7e9b6c4274797b7$export$da0a1bf29795ef91 = () => {
  $(".sliders-container").remove();
  (0, $67aff7fbf5506288$export$2e2bcd8739ae039)(".slider-page");
  (0, $b29e4f8572f5178c$export$92d4e20e0acb0b06)();
};
const $a7e9b6c4274797b7$export$8ff95cf51e6fac2b = () => {
  $(".control-panel").remove();
  (0, $ac4bc82834447809$export$2e2bcd8739ae039)(".toolbar-page");
  $("input[name='minScale']").on("change", (0, $e85695d92ef43ad2$export$897858b8ab7d7af7));
  $("input[name='maxScale']").on("change", (0, $e85695d92ef43ad2$export$88f9b7a69ad0b0c1));
  $("input[name='minPosition']").on("change", (0, $e85695d92ef43ad2$export$499c50b9584e2d6d));
  $("input[name='maxPosition']").on("change", (0, $e85695d92ef43ad2$export$eda6c2a03a956ab4));
  $("input[name='scaleStep']").on("change", (0, $e85695d92ef43ad2$export$baa808bb291a2865));
  $("input[name='verticalOrHorizontal']").on("change", (0, $e85695d92ef43ad2$export$2b1e75baf3a08712));
  $("input[name='singleOrRange']").on("change", (0, $e85695d92ef43ad2$export$af11dab7dd692ae9));
  $("input[name='progressBar']").on("change", (0, $e85695d92ef43ad2$export$cf8110c6412d0a13));
  $("input[name='scaleRange']").on("change", (0, $e85695d92ef43ad2$export$d1bf39eaaabfba47));
  (0, $b29e4f8572f5178c$export$92d4e20e0acb0b06)();
};


function $67aff7fbf5506288$var$initSlider(wrapper) {
  let state = (0, $7080dfdb5bc149f5$export$6f57813fe9f31bf9).getState();
...
export var $67aff7fbf5506288$export$2e2bcd8739ae039 = $67aff7fbf5506288$var$initSlider;




export class $ea895fed1e902031$export$f1e8abe023402588 {
...
let $859d9b41ce0aaed4$var$slider1 = new (0, $ea895fed1e902031$export$f1e8abe023402588)("1", "interval", "horizontal", 1, 50, 1, 100, 1, true, true);
$859d9b41ce0aaed4$var$slider1.init();
let $859d9b41ce0aaed4$var$slider2 = new (0, $ea895fed1e902031$export$f1e8abe023402588)("2", "interval", "vertical", 1, 20, 1, 20, 1, true, true);
$859d9b41ce0aaed4$var$slider2.init();
let $859d9b41ce0aaed4$var$slider3 = new (0, $ea895fed1e902031$export$f1e8abe023402588)("3", "single", "horizontal", 1, 20, 1, 20, 1, true, true);
$859d9b41ce0aaed4$var$slider3.init();
(0, $67aff7fbf5506288$export$2e2bcd8739ae039)(".slider-page");
(0, $b29e4f8572f5178c$export$2b57d60599a63da5)();
(0, $b29e4f8572f5178c$export$92d4e20e0acb0b06)();


//# sourceMappingURL=index.20a44db0.js.map
